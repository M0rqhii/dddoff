...
export const metadata: Metadata = {
  title: "Polityka cookies | DDDoff",
  description:
    "Polityka cookies serwisu DDDoff. Informacje o rodzajach cookies i sposobie zarządzania ustawieniami.",
};
      ...
      <main className="min-h-screen bg-slate-light px-5 py-12">
        <article className="mx-auto max-w-3xl rounded-2xl bg-white px-6 py-8 shadow-sm sm:px-10 sm:py-10">
          ...
          <p className="mt-2 text-sm text-text-muted">
            Ostatnia aktualizacja: {cookiePolicy.lastUpdated}
          </p>
